...
const CryptoDetails = () => {
  ...
  axios.get(`https://coinranking1.p.rapidapi.com/coin/${cointId}`, options)
      .then(response => {
  ...
  return (
    <>
      <Col className="coin-detail-container">
        ...
        <Row>
          <Col lg={11} md={24} className="stats-container">
            <Col className="coin-value-statistics">
              <Col className="coin-value-statistics-heading">
                ...
                <p>
                  An overview showing the statistics of {cryptoDetails.name}, such as the base and quote currency, the
          ...
          <Col lg={11} md={24} className="other-stats-info">
            <Col className="coin-value-statistics-heading">
              <Title level={3} className="coin-details-heading">
                Other Stats Info
              </Title>
